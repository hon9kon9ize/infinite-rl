...
class HtmlRewardFunction(RewardFunction):
    ...
    def compute_reward(
        self,
        model_output: str,
        reference_answer: Union[str, Dict[str, Any], Callable],
    ) -> RewardFunctionScore:
        """
        ...
        Args:
            ...
            reference_answer: The reference/expected HTML structure
        ...
        if callable(reference_answer):
            ...
            selectors = reference_answer.get("selectors", [])
            expected_html = reference_answer.get("expected_html", None)
